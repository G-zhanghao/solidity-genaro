...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
{
    ...
    { "DS_DATAVERSIONREAD",  Instruction::DATAVERSIONREAD },  
    { "DS_DATAVERSIONUPDATE", Instruction::DATAVERSIONUPDATE },
    { "DS_STORAGE_GAS_PRICE", Instruction::STORAGE_GAS_PRICE },
    { "DS_STORAGE_GAS_USED", Instruction::STORAGE_GAS_USED },
    { "DS_SENTINEL_HEFT", Instruction::SENTINEL_HEFT },
    { "DS_STORAGE_GAS", Instruction::STORAGE_GAS },      
    { "DS_SSIZE", Instruction::SSIZE }
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
    ...
    { Instruction::DATAVERSIONREAD, { "DS_DATAVERSIONREAD", 0, 4, 1, true, Tier::VeryLow}  },  
    { Instruction::DATAVERSIONUPDATE, { "DS_DATAVERSIONUPDATE", 0, 2, 1, true, Tier::VeryLow} },
    { Instruction::STORAGE_GAS_PRICE, { "DS_STORAGE_GAS_PRICE", 0, 2, 1, true, Tier::VeryLow} },
    { Instruction::STORAGE_GAS_USED, { "DS_STORAGE_GAS_USED", 0, 2, 1, true, Tier::VeryLow} },
    { Instruction::SENTINEL_HEFT, { "DS_SENTINEL_HEFT", 0, 1, 1, true, Tier::VeryLow} },
    { Instruction::STORAGE_GAS, { "DS_STORAGE_GAS", 0, 2, 1, true, Tier::VeryLow} },      
    { Instruction::SSIZE, {"DS_SSIZE", 0, 2, 1, true, Tier::VeryLow} }
