...
enum class Instruction: uint8_t
{
    ...
    DATAVERSIONREAD = 0x21,  ///< ds_storage
    DATAVERSIONUPDATE = 0x22,///< ds_storage
    ...
    STORAGE_GAS_PRICE = 0x3f,///< ds_storage
    ...
    STORAGE_GAS_USED = 0x46,///< ds_storage
    SENTINEL_HEFT = 0x47,///< ds_storage
    ...
    STORAGE_GAS = 0x5c, ///< ds_storage
    SSIZE = 0x5d,       ///< ds_storage
